...
if(isset($_SESSION["userid"]) && !empty($_SESSION["userid"]))
{
	...
	$id = $_SESSION['userid'];
	$result = mysqli_query($con,"select username,mobile,gender,profile from adminusers where id=$id");
		...
		<html lang="en">
			...
			<body>
				...
				if(isset($_POST['save']))
				{
					...
					mysqli_query($con,"update adminusers set username='$uname', mobile='$mobile', gender='$gender' where id=$id");
