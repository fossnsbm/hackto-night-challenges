    ...
    <form method="post" name="logform" action="register_action.php" onsubmit="return validtext()">
        <table class="formtable t1" border="0">
            ...
            <tr>
                <td>
                    <p>Password</p>
                    <input type="password" name="Pword" size="30" maxlength="30" placeholder="Enter a Password" required>
                </td>
                <td>
                    <p>Confirm Password</p>
                    <input type="password" name="confirmpassword" size="30" maxlength="30" placeholder="Re-enter Your Password" required>
            </tr>
            <tr>
                <td>
                    <p>Mobile Number</p>
...
<head>
    <meta charset="UTF-8">
    <title>Registration Step 1</title>
    <link rel="stylesheet" type="text/css" href="regss.css">
    <script lang="javascript" type="text/javascript" src="regjs.js"></script>
</head>
